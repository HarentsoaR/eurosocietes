...
class UpdateEntrepriseRequest extends FormRequest
{
    ...
    {
        $siren = $this->route('entreprise');

        return [
            // siren is intentionally absent → immutable on update
            ...
            'slug' => ['nullable', 'string', 'max:180', Rule::unique('entreprises', 'slug')->ignore($siren, 'siren')],
